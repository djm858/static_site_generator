    ...
    for block in blocks:
        ...
        match block_type:
            ...
            case BlockType.HEADING:
                ...
                text_nodes = text_to_textnodes(match[2])
                children = []
                for text_node in text_nodes:
                    children.append(text_node_to_html_node(text_node))
